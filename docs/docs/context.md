...
* Тепер _менеджер контекстів_ продовжує викликати _tick_ у основного модуля налаштувань, а той віддає увесь свій час _одному із вкладених активних контекстів_, поки його не буде звільнено. 

!!! note "Важливо" 
    Якщо поточний контекст передає свій час підмодулю, він мусить повернути _false_ із перевизначеного метода _loop_. Це означатиме, що він не повинен додатково оновлювати стан вводу чи відмальовувати UI тому що цим займеться субмодуль.
